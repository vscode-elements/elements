 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,s,i){const o=e[0];if("."===o){return new _(t,e.slice(1),s).parts}if("@"===o)return[new I(t,e.slice(1),i.eventContext)];if("?"===o)return[new O(t,e.slice(1),s)];return new S(t,e,s).parts}handleTextExpression(t){return new C(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
